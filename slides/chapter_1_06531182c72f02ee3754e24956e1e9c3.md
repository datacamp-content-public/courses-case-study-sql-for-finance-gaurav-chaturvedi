...
Step 1: Aggregate the required margin and unrealised gain from the fx_position_plus table at the customer level. Create a new table customer_margin_gain.
