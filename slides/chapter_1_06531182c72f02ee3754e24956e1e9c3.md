...
`@script`
Step 2: Now you need to Join this newly created table with customer_balance table to bring the cash balance together with the required margin and unrealized gain. 
...
In Step 3, you will use the formula of Free Margin to add a new field and create a new table. This will be our output dataset customer_free_margin
