...
Step 1: Aggregate the required margin and unrealised gain from the fx_position_plus table at the customer level. Create a new intermediate table called customer_margin_gain.
...
`@script`
Now you have the 3 data points to calculate Free Margin for a Customer. 

In Step 3, you will use the formula of Free Margin to add a new field in the customer_margin_gain_balance table and create a new table. This will be our output dataset customer_free_margin
