...
![](https://assets.datacamp.com/production/repositories/5112/datasets/f8d7d3166396b9d23654e3273516fd8872e97fa4/Img5v4.png =90)

`@script`
Time to have some fun with data and SQL. 

In this lesson you will use 4 datasets - 3 of which you are already familiar with: 
1."fx_rates" has the currency rates by date. 
2."fx_positions_plus" has all customer open positions and the 2 computed fields - required margin and unrealised gain
3."margin_master" has currency-pair wise margin requirement 
 
We will introduce a new Customer level dataset called customer_balance. The customer opening cash balance will be provided in this table.
