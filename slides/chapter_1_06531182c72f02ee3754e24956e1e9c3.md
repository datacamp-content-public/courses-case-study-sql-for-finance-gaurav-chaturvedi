...
`@script`
Customer A had only 1 FX position - the 1 lot of EUR-USD. In practice, customers can have multiple open positions. 

In such cases, the required margin and unrealised gain is the total across all his positions. 

The Free Margin calculation for a customer will use these total values of Required Margin and Unrealised Gain.
